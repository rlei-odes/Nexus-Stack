...
| **[Kestra](https://github.com/stefanko-ch/Nexus-Stack/blob/main/docs/stacks/kestra.md)** | `kestra/kestra:latest` | YAML-defined declarative workflow orchestration. Event-driven, plugin-rich, and language-agnostic. Always protected by Cloudflare Access — it touches every downstream system. |
