...
### Infrastructure
- **Hetzner Cloud Server** - x86 (cpx22/cpx32) running Ubuntu 24.04 — [defaults switched from ARM in 2026-05](docs/admin-guides/setup-guide.md) due to (a) ongoing ARM EU capacity shortage and (b) Hetzner's 2025+ pricing flip where ARM is now ~40% more expensive than equivalent x86
